...
удаление/редактирования статьи если она принадлжит вам
...
добавить владельца статьи, и разрешить переходить по адресу только ему или мочератору

сделать страницу профиля
